...
public class AsciiPanel extends JPanel {
    ...
    public static Color cyanMid = new Color(0, 198, 198);
    ...
    public static Color brightTeal = new Color(1, 255, 200);
    public static Color brightCyan = new Color(0, 255, 255);
    public static Color brightWhite = new Color(255, 255, 255);

    public static Color brown = new Color(153, 76, 0);
    public static Color pink = new Color(255, 204, 229);
    public static Color darkPink = new Color(155, 104, 129);
    public static Color orange = new Color(255, 128, 0);
    public static Color peach = new Color(255, 198, 100);
    public static Color olive = new Color(102, 152, 0);
    public static Color lime = new Color(100, 255, 100);

    public static Color brightGrey = new Color(180, 180, 180);
    public static Color grey = new Color(100, 100, 100);
    public static Color darkGrey = new Color(40, 40, 40);
    public static Color purple = new Color(90, 0, 145);
    public static Color brightPurple = new Color(190, 0, 255);
    ...
    public void setCharWidth(int x){ charHeight = x; }
    public void setCharHeight(int y){ charHeight = y; }
    ...
    public AsciiPanel(int width, int height) {
        ...
        //charWidth = (int)((screenSize.width) / width);
        //charHeight = (int)((screenSize.height * .95) / height);
        /////
        charWidth = 18; charHeight = 28; /////
    ...
    public void fillScreen(){
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        charWidth = (int)((screenSize.width) / widthInCharacters);
        charHeight = (int)((screenSize.height * .95) / heightInCharacters);
        changeSettings(charWidth, charHeight);
    }

    public AsciiPanel changeSettings(int x, int y){
        charWidth = x;
        charHeight = y;
    ...
    public void forgetPaint(){
        //int y = (int)(Math.random() * heightInCharacters);
        for(int x=0; x<widthInCharacters; x++){
            oldChars[x][yForget] = (char)166;
        }
        yForget ++;
        if(yForget >= heightInCharacters){ yForget = 0; }
        if(true){ return; }
    ...
    public void paint(Graphics g) {
        ...
        for (int x = 0; x < widthInCharacters; x++) {
            for (int y = 0; y < heightInCharacters; y++) {
                ...
                BufferedImage img;
                try {
                    img = op.filter(glyphs[chars[x][y]], null);
                } catch (NullPointerException e){
                    //System.out.println("op.filter fail");
                    return;
                }


                offscreenGraphics.drawImage(img, x * charWidth, y * charHeight, null);
                //offscreenGraphics.drawImage(img, x * charWidth, y * charHeight, charWidth, charHeight, null);
    ...
    private void loadGlyphs() {
        try {
            ...
            glyphSprite = ImageIO.read(new File("cp4372.png"));
        ...
        for (int i = 0; i < 256; i++) {
            ...
            glyphs[i].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, sx, sy, sx + 9, sy + 16, null);
        }
    }

    private LookupOp setColors(Color bgColor, Color fgColor) {
        if(bgColor == null){ bgColor = AsciiPanel.black;}
        if(fgColor == null){ fgColor = AsciiPanel.white;}
